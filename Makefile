...
$(PROG): pre_process.o construct_t.o read_file.o delete_unused_PO.o trav_Po_add_to_set.o read_weight.o main.o ResourceAwarePatchGeneration.o write_patch.o $(satAndInterDir)/interpolation.o $(satAndInterDir)/NtkToCnfConverter.o $(abcLibDir)/$(abcLib) 
	$(LD) $(LDFLAGS) -o $@ $^
